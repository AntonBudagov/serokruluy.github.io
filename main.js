;(function () {
    ...
    var sizeEl = 200; // размер квадрата
    var objs = [];
    var animId;
    var allInHome;
    var cursorForceZoomed = 40000;
    var damping = 0.85;
    var inHome = 0;
    var m = 1;
    var kSpring = 1;
    ...
    function createEls() {
        ...
        // }
          ...
          elements.each(function(count) {
            ...
            var i = 0;
            var j = 0;
            i = Math.random() * ((winW - $(this).width())/ $(this).width());
            j = Math.random() * ((winH - $(this).height())/$(this).height());
            //var this = $(this);
            console.log(i)
        ...
        // $objs = $container.find('Squares-item');
        // console.log(2)
    }
